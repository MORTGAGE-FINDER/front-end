...
export default function Home() {
    return (
        ...
        <div className="bg-[url('/images/dillon-kydd-2keCPb73aQY-unsplash.jpg')] h-screen w-screen bg-cover bg-center overflow-hidden relative">
