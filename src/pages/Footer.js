...
export default function Footer() {
    return (
        <footer className="p-2 bg-white sm:p-0.5 dark:bg-gray-900 fixed bottom-0 w-full mt-5">
            <div className="sm:flex sm:items-center sm:justify-between pt-3 pb-3">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://github.com/orgs/MORTGAGE-FINDER/repositories" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
